...
<h2><p style="float:left;">List Of Categories!</p></h2><h3><p align="center">${message}</p></h3>
 <p align="right">
<a href="categories"><button  type="button" >ADD </button></a>
</p>
 <p style="text-align: justify;">
	...
	<tr ng-repeat="resource in names | filter:search">		
			<td>{{ resource.id }}</td> 
		<td>{{ resource.name}}</td>
		<td>{{ resource.description}}</td><td align="center"> <a href="edit/{{resource.id}}">Edit</a> | <a href="delete/{{resource.id}}">Delete</a></td>
   	</tr>
	</table>    
	<script>
