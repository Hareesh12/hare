            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <c:if test="${role='admin'}">
                        <c:set var="url" scope="page" value="/adminhome/productinventory" />
                    </c:if>
                    ...
                    <p ng-controller="cartCtrl">
                        ...
                        <a href="<spring:url value="/customer/cartitem" />" class="btn btn-default"><span class="glyphicon glyphicon-hand-right"></span> View Cart</a>
                    </p>
